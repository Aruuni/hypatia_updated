...
void TcpOptimizer::Generic() {
    ...
    // Initial ssthresh
    // int64_t innitialssthresh = 10;   // 
    // printf("  > Segment size............... %u byte\n", innitialssthresh);
    // Config::SetDefault("ns3::TcpSocket::InitialSlowStartThreshold", UintegerValue(innitialssthresh));


    // Send buffer size
    //int64_t snd_buf_size_byte = 131072 * 256;  // 131072 bytes = 128 KiB is default, we set to 32 MiB
    int64_t snd_buf_size_byte = 4194304;  // 131072 bytes = 128 KiB is default, we set to 32 MiB
    ...
    int64_t rcv_buf_size_byte = 6291456;  // 131072 bytes = 128 KiB is default, we set to 32 MiB
    ...
    // Pacing
    bool pacing_enabled = true;  // Default: false.
